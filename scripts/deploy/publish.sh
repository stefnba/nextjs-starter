...
# migrate db
docker compose -f docker/docker-compose.yml -f docker/docker-compose.prod.yml -f docker/docker-compose.deploy.yml --project-directory . run --rm -it --entrypoint "npx prisma db push" app
